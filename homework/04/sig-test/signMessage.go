...
var commandSignMessage = cli.Command{
	...
	Usage: `sign a message
						./sig-test sign-message <KeyFile.json> "the message to sign"
							or
						./sig-test sign-message --gen-msg <KeyFile.json> 
							or
						./sig-test sign-message --msgfile <MessageInAFile> <KeyFile.json> 
							or
						./sig-test sign-message --gen-msg <KeyFile.json> 
`,
