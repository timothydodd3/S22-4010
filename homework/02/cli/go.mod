module github.com/Univ-Wyo-Education/S22-4010/homework/02/cli

go 1.17

require (
	github.com/Univ-Wyo-Education/S22-4010/homework/02/block v0.0.1
	github.com/Univ-Wyo-Education/S22-4010/homework/02/config v0.0.1
	github.com/Univ-Wyo-Education/S22-4010/homework/02/index v0.0.1
	github.com/Univ-Wyo-Education/S22-4010/homework/02/lib v0.0.1
	github.com/Univ-Wyo-Education/S22-4010/homework/02/mine v0.0.1
)
